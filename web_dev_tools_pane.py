...
class WebDevToolsPane(QDockWidget):
    ...
    def __init__(self, title, parent=None):
        ...
        self.toggleViewAction().setText(f'Toggle {title}')
    ...
    def setup_web(self, page):
        ...
        # make sure to dock the pane when displaying
    ...
    def on_anki_unload_profile(self):
        # See aqt/main.py > AnkiQt/_checkForUnclosedWidgets()
        self.delete_web()
        self.hide()
